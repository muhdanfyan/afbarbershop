...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" style="box-shadow: none; border: none; background: transparent;">
    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background: #111827 !important; border-bottom: none;">
        @php
    ...
    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between px-4" style="background: #ffffff; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border-bottom: 1px solid #f1f5f9;">
