...
<head>
    ...
    <title>Login - {{ \App\Models\Setting::where('key', 'nama_usaha')->value('value') ?? 'AF Barbershop' }}</title>
    <script src="https://cdn.tailwindcss.com"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="shortcut icon" href="{{ asset('storage/' . \App\Models\Setting::where('key', 'logo')->value('value')) }}"
        type="image/x-icon">
    <style>
