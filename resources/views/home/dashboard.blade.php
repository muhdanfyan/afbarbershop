        ...
        <div class="container">
            ...
            <div
                ...
                <div class="logo-wrapper">
                    <a href="/dashboard">
                        <img src="{{ asset('/') }}afan/img/core-img/logo.png" alt="">
                    </a>
                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/pwa.png" alt="">
                                </div>
                        ...
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/bootstrap.png" alt="">
                                </div>
                        ...
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/js.png" alt="">
                                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/sass.png" alt="">
                                </div>
                                <p class="mb-0">SCSS</p>
                            </div>
                        </div>
                        ...
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/npm.png" alt="">
                                </div>
                                <p class="mb-0">npm</p>
                            </div>
                        </div>
                        ...
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/gulp.png" alt="">
                                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/dark.png" alt="">
                                </div>
                        ...
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/rtl.png" alt="">
                                </div>
                        ...
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/code.png" alt="">
                                </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/star.png" alt="">
                                </div>
                        ...
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/elegant.png" alt="">
                                </div>
                        ...
                        <div class="col-4">
                            <div class="feature-card mx-auto text-center">
                                <div class="card mx-auto bg-gray">
                                    <img src="{{ asset('/') }}afan/img/demo-img/lightning.png" alt="">
                                </div>
